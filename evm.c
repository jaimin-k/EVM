...
sbit ini_pin = P0^0; // Start voting pin
sbit stop_pin = P0^5; // Stop voting pin
sbit candidate_1=P0^1; //Candidate1
sbit candidate_2=P0^2; //Candidate2
sbit candidate_3=P0^3; //Candidate3
sbit candidate_4=P0^4; //Candidate4
int max = 0;
int carry = 0;
int arr[4];
int vote_amt[3],j;
